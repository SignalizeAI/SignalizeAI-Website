          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
            <div>
              ...
              <p className="mt-6 max-w-[640px] text-lg leading-8 text-slate-600 dark:text-white/65">
                SignalizeAI turns public business websites into usable sales
                context. Instead of stitching together copy, positioning,
                audience clues, and readiness signals by hand, the extension
                generates a structured read that is easier to act on.
              </p>
        ...
        <div className="container">
          <div className="mx-auto mb-14 max-w-[840px] text-center">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600 dark:text-white/65">
              The core product is the same, but the reason people reach for it
              changes depending on whether they are selling, operating, or
              researching.
            </p>
          </div>
